class VoteManagementDetailsSerializer < BaseSerializer
  attributes :id, :auto_generate_id, :created_date, :created_by, :association_id, :association_name, :meeting_type, :category, :ratification_type, :title, :approval_due_date ,:is_voting_open, :status, :updated_at
